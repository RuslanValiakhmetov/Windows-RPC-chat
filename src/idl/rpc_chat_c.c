...
static const RPC_CLIENT_INTERFACE RpcChat___RpcClientInterface =
    {
...
RPC_IF_HANDLE client_RpcChat_v1_0_c_ifspec = (RPC_IF_HANDLE)& RpcChat___RpcClientInterface;

extern const MIDL_STUB_DESC RpcChat_StubDesc;

static RPC_BINDING_HANDLE RpcChat__MIDL_AutoBindHandle;
    ...
    /* [string][out] */ unsigned char errorMessage[ 256 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &rpc_chat__MIDL_ProcFormatString.Format[0],
                  IDL_handle,
                  userName,
                  userID,
                  errorMessage);
    return ( STATUS  )_RetVal.Simple;
    ...
    /* [string][out] */ unsigned char errorMessage[ 256 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcChat_StubDesc,
                  (PFORMAT_STRING) &rpc_chat__MIDL_ProcFormatString.Format[54],
                  IDL_handle,
                  message,
                  userID,
                  errorMessage);
    ...
    /* [string][out] */ unsigned char errorMessage[ 256 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcChat_StubDesc,
                  (PFORMAT_STRING) &rpc_chat__MIDL_ProcFormatString.Format[108],
                  IDL_handle,
                  userID,
                  errorMessage);
    return ( STATUS  )_RetVal.Simple;
    ...
    /* [string][out] */ unsigned char errorMessage[ 256 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcChat_StubDesc,
                  (PFORMAT_STRING) &rpc_chat__MIDL_ProcFormatString.Format[156],
                  IDL_handle,
                  userID,
                  errorMessage);
    return ( STATUS  )_RetVal.Simple;
    ...
    /* [string][out] */ unsigned char errorMessage[ 256 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RpcChat_StubDesc,
                  (PFORMAT_STRING) &rpc_chat__MIDL_ProcFormatString.Format[204],
                  IDL_handle,
                  userID,
                  errorMessage);
    return ( STATUS  )_RetVal.Simple;
...
static const MIDL_STUB_DESC RpcChat_StubDesc = 
    {
    (void *)& RpcChat___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &RpcChat__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
...
static const SERVER_ROUTINE RpcChat_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)server_GetOnlineUsersCb,
    (SERVER_ROUTINE)server_UpdateUsersStatusCb,
    (SERVER_ROUTINE)server_UpdateMessageCb
    };
...
static const MIDL_SERVER_INFO RpcChat_ServerInfo = 
    ...
    _callbackRpcChat_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
